...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="CurrencyChangesTelegramBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.yelzhan.tgbot.Bot %CMD_LINE_ARGS%
